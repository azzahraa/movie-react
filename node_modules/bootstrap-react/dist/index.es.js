...
const Button = forwardRef((_a, ref) => {
    var { children, size, disabled, layout, variant, color = "primary", utilities = "", active } = _a, props = __rest(_a, ["children", "size", "disabled", "layout", "variant", "color", "utilities", "active"]);
    const additionalProps = {};
    additionalProps.ref = ref;
    let className = variant !== "close"
    ...
    return (React__default.createElement("button", Object.assign({}, props, additionalProps, { className: className }), children));
});
const ButtonGroup = forwardRef((_a, ref) => {
    var { children, size, orientation = "horizontal", utilities = "" } = _a, props = __rest(_a, ["children", "size", "orientation", "utilities"]);
...
const ButtonToolbar = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `btn-toolbar ${utilities}`, role: "toolbar", ref: ref }), children));
});
const Close = forwardRef((_a, ref) => {
    var props = __rest(_a, ["children"]);
    return (React__default.createElement(Button, Object.assign({}, props, { variant: "close", "aria-label": "close", ref: ref }),
        React__default.createElement("span", { "aria-hidden": "true" }, "\u00D7")));
});

const Alert = forwardRef((_a, ref) => {
    var { color = "primary", dismissable, children, onDismiss, onDismissed, visible = true, utilities = "" } = _a, divProps = __rest(_a, ["color", "dismissable", "children", "onDismiss", "onDismissed", "visible", "utilities"]);
    const [_visible, set] = useSharedState(visible, onDismiss);
    const isDismissable = dismissable || onDismiss;
    if (isDismissable) {
        utilities += " alert-dismissible";
    }
    return (React__default.createElement(AnimatePresence, { initial: false }, _visible && (React__default.createElement(motion.div, Object.assign({}, divProps, { ref: ref, initial: false, exit: { opacity: 0 }, onAnimationComplete: onDismissed, className: `alert alert-${color} ${utilities}`, role: "alert" }),
        children,
        isDismissable && React__default.createElement(Close, { onClick: () => set(false) })))));
});
const AlertHeading = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("h4", Object.assign({ ref: ref }, props, { className: `alert-heading ${utilities}` }), children));
});
const AlertLink = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("a", Object.assign({}, props, { ref: ref, className: `alert-link ${utilities}` }), children));
});

const Badge = forwardRef((_a, ref) => {
    var { children, variant = "rectangle", color = "primary", utilities = "" } = _a, props = __rest(_a, ["children", "variant", "color", "utilities"]);
    props = Object.assign(Object.assign({}, props), { className: `badge bg-${color} ${utilities}` });
    if (color === "light") {
    ...
    return (React__default.createElement("span", Object.assign({}, props, { ref: ref }), children));
});

const Breadcrumb = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("nav", { "aria-label": "breadcrumb", ref: ref },
        React__default.createElement("ol", Object.assign({ className: `breadcrumb ${utilities}` }, props), children)));
});
const BreadcrumbItem = forwardRef((_a, ref) => {
    var { active, utilities = "", children } = _a, props = __rest(_a, ["active", "utilities", "children"]);
    const listItemProps = {
    ...
    return (React__default.createElement("li", Object.assign({}, listItemProps, { ref: ref }), props.href ? React__default.createElement("a", Object.assign({}, props), children) : children));
});

const Card = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `card ${utilities}`, ref: ref }), children));
});
const CardHeader = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `card-header ${utilities}`, ref: ref }), children));
});
const CardFooter = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `card-footer ${utilities}`, ref: ref }), children));
});
const CardBody = forwardRef((_a, ref) => {
    var { children, utilities = "", orientation } = _a, props = __rest(_a, ["children", "utilities", "orientation"]);
    const className = orientation === "overlay" ? "card-img-overlay" : "card-body";
    return (React__default.createElement("div", Object.assign({}, props, { className: `${className} ${utilities}`, ref: ref }), children));
});
const CardTitle = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("h5", Object.assign({}, props, { className: `card-title ${utilities}`, ref: ref }), children));
});
const CardSubtitle = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("h6", Object.assign({}, props, { className: `card-subtitle ${utilities}`, ref: ref }), children));
});
const CardText = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("p", Object.assign({}, props, { className: `card-text ${utilities}`, ref: ref }), children));
});
const CardGroup = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `card-group ${utilities}`, ref: ref }), children));
});
const CardLink = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("a", Object.assign({}, props, { className: `card-link ${utilities}`, ref: ref }), children));
});
const CardImage = forwardRef((_a, ref) => {
    var { orientation, utilities = "" } = _a, props = __rest(_a, ["orientation", "utilities"]);
    const className = orientation === "top" ? "card-image-top" : "card-image";
    return React__default.createElement("img", Object.assign({}, props, { className: `${className} ${utilities}`, ref: ref }));
});

const SR = forwardRef(({ children }, ref) => (React__default.createElement("span", { className: `sr-only`, ref: ref }, children)));
...
const Carousel = forwardRef((_a, ref) => {
    var { utilities = "", indicators = true, controls = true, index = 0, transition = "slide", useGestures = true, interval = 5000 } = _a, props = __rest(_a, ["utilities", "indicators", "controls", "index", "transition", "useGestures", "interval"]);
    ...
    return (React__default.createElement("div", { className: `carousel ${utilities}`, ref: ref },
...
const CarouselItem = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `carousel-item active ${utilities}`, ref: ref }), children));
});
/**
...
const CarouselCaption = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { style: { transition: "none" }, className: `carousel-caption ${utilities}`, ref: ref }), children));
});
...
const Collapse = forwardRef(({ visible, utilities = "", children }, ref) => {
    return (React__default.createElement(motion.div, { ref: ref, key: "content", initial: false, animate: visible ? "open" : "collapsed", exit: "collapsed", variants: {
        ...
        }, transition: { ease: [0.15, 0.72, 0.34, 1], duration: 0.2 }, className: utilities }, children));
});
const Accordion = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `accordion ${utilities}`, ref: ref }), children));
});

let counter = 0;
const Dropdown = forwardRef((_a, forwardedRef) => {
    var { alignment = "left", direction = "down", variant = "dropdown", utilities = "", trigger = "click", onToggle, children, action, toggle } = _a, props = __rest(_a, ["alignment", "direction", "variant", "utilities", "trigger", "onToggle", "children", "action", "toggle"]);
    ...
    const toggler = typeof toggle === "string"
        ...
        : toggle;
    return (React__default.createElement("div", Object.assign({ ref: ref }, props, { className: `dropdown ${variant} ${dropDirection} ${utilities}` }),
        action,
        toggler(toggleProps),
...
const DropdownMenu = forwardRef((_a, ref) => {
    var { children, visible, alignment = "left", utilities = "" } = _a, props = __rest(_a, ["children", "visible", "alignment", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { ref: ref, className: `dropdown-menu ${visible ? "show" : ""} ${alignment === "right" ? "dropdown-menu-right" : ""} ${utilities}` }), children));
});
...
const DropdownHeader = forwardRef((_a, ref) => {
    var { children } = _a, props = __rest(_a, ["children"]);
    return (React__default.createElement("h6", Object.assign({}, props, { className: "dropdown-header", ref: ref }), children));
});
const DropdownItemText = forwardRef((_a, ref) => {
    var { children } = _a, props = __rest(_a, ["children"]);
    return (React__default.createElement("span", Object.assign({}, props, { className: "dropdown-item-text", ref: ref }), children));
});
const DropdownItem = forwardRef((_a, ref) => {
    var { children } = _a, props = __rest(_a, ["children"]);
    return (React__default.createElement("a", Object.assign({}, props, { className: "dropdown-item", ref: ref }), children));
});
const DropdownToggle = forwardRef((_a, ref) => {
    var { children, split, utilities } = _a, props = __rest(_a, ["children", "split", "utilities"]);
    return (React__default.createElement(Button, Object.assign({}, props, { utilities: `dropdown-toggle ${split ? "dropdown-toggle-split" : ""} ${utilities}`, ref: ref }),
        children,
        split && React__default.createElement(SR, null, "Toggle Dropdown")));
});
const NavLinkToggle = forwardRef((_a, ref) => {
    var { children, utilities, onClick } = _a, props = __rest(_a, ["children", "utilities", "onClick"]);
    return (React__default.createElement("a", Object.assign({}, props, { onClick: (e) => {
            e.preventDefault();
            onClick && onClick(e);
        }, href: "#", className: "nav-link dropdown-toggle", ref: ref }), children));
});

const ListGroup = forwardRef((_a, ref) => {
    var { children, layout, utilities = "" } = _a, props = __rest(_a, ["children", "layout", "utilities"]);
    if (layout) {
        utilities += ` list-group-${layout}`;
    }
    return (React__default.createElement("div", Object.assign({}, props, { className: `list-group ${utilities}`, ref: ref }), children));
});
const ListGroupItem = forwardRef((_a, ref) => {
    var { children, utilities = "", active, disabled, color, href, type } = _a, itemProps = __rest(_a, ["children", "utilities", "active", "disabled", "color", "href", "type"]);
...
const Modal = forwardRef(({ utilities = "", visible, children, transition = "tween", onDismiss, scrollable = false, alignment = "top", }, ref) => {
    useEffect(() => {
        if (visible) {
    ...
    return (React__default.createElement(AnimatePresence, null,
        ...
        visible && (React__default.createElement(motion.div, { ref: ref, onClick: onDismiss, key: "modal", initial: "hidden", animate: "visible", exit: "hidden", variants: {
                hidden: {
                    opacity: 0,
            ...
            }, className: `modal show ${utilities}`, tabIndex: -1, role: "dialog", style: { display: "block" } },
            React__default.createElement(ModalDialog, { onClick: (e) => e.stopPropagation(), utilities: "show", scrollable: scrollable, alignment: alignment },
                React__default.createElement(ModalContent, null, children))))));
});
const ModalDialog = forwardRef((_a, ref) => {
    var { utilities = "", children, scrollable, alignment } = _a, props = __rest(_a, ["utilities", "children", "scrollable", "alignment"]);
    ...
    ${utilities}`, ref: ref }), children));
});
const ModalContent = forwardRef((_a, ref) => {
    var { utilities = "", children } = _a, props = __rest(_a, ["utilities", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `modal-content ${utilities}`, ref: ref }), children));
});
const ModalHeader = forwardRef((_a, ref) => {
    var { utilities = "", children, onDismiss } = _a, props = __rest(_a, ["utilities", "children", "onDismiss"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `modal-header ${utilities}`, ref: ref }),
        children,
        onDismiss && React__default.createElement(Close, { onClick: onDismiss })));
});
const ModalTitle = forwardRef((_a, ref) => {
    var { utilities = "", children } = _a, props = __rest(_a, ["utilities", "children"]);
    return (React__default.createElement("h5", Object.assign({}, props, { className: `modal-title ${utilities}`, ref: ref }), children));
});
const ModalBody = forwardRef((_a, ref) => {
    var { utilities = "", children } = _a, props = __rest(_a, ["utilities", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `modal-body ${utilities}`, ref: ref }), children));
});
const ModalFooter = forwardRef((_a, ref) => {
    var { utilities = "", children } = _a, props = __rest(_a, ["utilities", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `modal-footer ${utilities}`, ref: ref }), children));
});
const ModalBackdrop = forwardRef((_a, ref) => {
    var { utilities = "", children } = _a, props = __rest(_a, ["utilities", "children"]);
    return (React__default.createElement(motion.div, Object.assign({}, props, { className: `modal-backdrop ${utilities}`, ref: ref }), children));
});

const Nav = forwardRef((_a, ref) => {
    var { children, utilities = "", variant, layout } = _a, props = __rest(_a, ["children", "utilities", "variant", "layout"]);
    if (variant) {
    ...
    return (React__default.createElement("div", Object.assign({}, props, { className: `nav ${utilities}`, role: "navigation", ref: ref }), children));
});
const NavLink = forwardRef((_a, ref) => {
    var { children, disabled, utilities = "", active } = _a, props = __rest(_a, ["children", "disabled", "utilities", "active"]);
    if (active) {
        utilities += " active";
    }
    if (disabled) {
    ...
    return (React__default.createElement("a", Object.assign({}, props, { className: `nav-item nav-link ${utilities}`, ref: ref }), children));
});
const TabContent = forwardRef((_a, ref) => {
    var { index = 0, utilities = "", onTab } = _a, props = __rest(_a, ["index", "utilities", "onTab"]);
    const children = React__default.Children.toArray(props.children);
    return (React__default.createElement("div", Object.assign({}, props, { className: `tab-content ${utilities}`, role: "navigation", ref: ref }),
...
const TabPane = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `tab-pane ${utilities} active`, role: "tabpanel", ref: ref }), children));
});

const Navbar = forwardRef((_a, ref) => {
    var { children, utilities = "", color = "light", expand = "sm", container, brand } = _a, props = __rest(_a, ["children", "utilities", "color", "expand", "container", "brand"]);
    const size = useWindowSize();
    ...
    return (React__default.createElement("nav", Object.assign({}, props, { className: `navbar ${utilities}`, role: "navigation", ref: ref }), navChildren));
});
...
const NavbarBrand = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("a", Object.assign({}, props, { className: `navbar-brand ${utilities}`, ref: ref }), children));
});
const NavbarToggler = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("button", Object.assign({}, props, { className: `navbar-toggler ${utilities}`, type: "button", "aria-label": "Toggle navigation", ref: ref }),
        React__default.createElement("span", { className: "navbar-toggler-icon" })));
});
const NavbarNav = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `navbar-nav ${utilities}`, role: "navigation", ref: ref }), children));
});
const NavbarText = forwardRef((_a, ref) => {
    var { children, utilities = "" } = _a, props = __rest(_a, ["children", "utilities"]);
    return (React__default.createElement("span", Object.assign({}, props, { className: `navbar-text ${utilities}`, role: "navigation", ref: ref }), children));
});

const Pagination = forwardRef((_a, ref) => {
    var { children, utilities = "", size } = _a, props = __rest(_a, ["children", "utilities", "size"]);
    const abbrSize = useSizeToAbbr(size);
    if (abbrSize)
        utilities += ` pagination-${abbrSize}`;
    return (React__default.createElement("nav", Object.assign({}, props, { ref: ref }),
        React__default.createElement("ul", { className: `pagination ${utilities}` }, children)));
});
const PaginationItem = forwardRef((_a, ref) => {
    var { children, utilities = "", active, disabled, href = "#" } = _a, props = __rest(_a, ["children", "utilities", "active", "disabled", "href"]);
    if (disabled) {
        props.tabIndex = -1;
        props["aria-disabled"] = "true";
    }
    return (React__default.createElement("li", { className: `page-item ${active ? "active" : ""} ${disabled ? "disabled" : ""}` },
        React__default.createElement("a", Object.assign({ className: `page-link ${utilities}`, href: href }, props, { ref: ref }), children)));
});
...
const PopoverElement = forwardRef((_a, ref) => {
    var { style, placement, arrowProps, utilities = "", title, children } = _a, divProps = __rest(_a, ["style", "placement", "arrowProps", "utilities", "title", "children"]);
    return (React__default.createElement(motion.div, Object.assign({ ref: ref, style: style, initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, "data-placement": placement, role: "tooltip", className: `popover bs-popover-${placement} ${utilities}` }, divProps),
...
const Progress = forwardRef((_a, ref) => {
    var { utilities = "", children } = _a, props = __rest(_a, ["utilities", "children"]);
    return (React__default.createElement("div", Object.assign({ className: `progress ${utilities}` }, props, { ref: ref }), children));
});
const ProgressBar = forwardRef((_a, ref) => {
    var { utilities = "", variant = "solid", value = 0, children } = _a, props = __rest(_a, ["utilities", "variant", "value", "children"]);
    if (variant === "stripe") {
        utilities += " progress-bar-striped progress-bar-animated";
    }
    return (React__default.createElement("div", Object.assign({}, props, { "aria-valuenow": value, "aria-valuemin": 0, "aria-valuemax": 100, style: { width: `${value}%` }, role: "progressbar", className: `progress-bar ${utilities}`, ref: ref }), children));
});

const Spinner = forwardRef((_a, ref) => {
    var { utilities = "", variant = "border", size, color, children } = _a, props = __rest(_a, ["utilities", "variant", "size", "color", "children"]);
    if (color) {
    ...
    return (React__default.createElement("div", Object.assign({}, props, { className: `spinner-${variant} ${utilities}`, ref: ref }),
        React__default.createElement(SR, null, "Loading...")));
});

const Toaster = forwardRef(({ utilities = "", children, duration = 5 }, ref) => {
    ...
    return (React__default.createElement("div", { className: utilities, style: {
            position: "fixed",
            bottom: 15,
            right: 15,
            width: "350px",
...
const Toast = forwardRef(({ utilities = "", dismissable = true, title, time, onDismiss, children, body, icon, duration = 5, key, }, ref) => {
    useEffect(() => {
        onDismiss && setTimeout(onDismiss, duration * 1000);
    }, [onDismiss]);
    return (React__default.createElement(motion.div, { ref: ref, className: `toast show ${utilities}`, role: "alert", "aria-live": "assertive", "aria-atomic": "true", initial: { opacity: 0, height: 0 }, animate: {
            opacity: 1,
            height: "auto",
        ...
        (icon || title || time || dismissable) && (React__default.createElement(ToastHeader, null,
            ...
            dismissable && React__default.createElement(Close, { onClick: onDismiss, utilities: "ml-2 mb-1" }))),
...
const ToastHeader = forwardRef((_a, ref) => {
    var { utilities = "", children } = _a, props = __rest(_a, ["utilities", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `toast-header ${utilities}`, ref: ref }), children));
});
const ToastBody = forwardRef((_a, ref) => {
    var { utilities = "", children } = _a, props = __rest(_a, ["utilities", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `toast-body ${utilities}`, ref: ref }), children));
});
...
const TooltipElement = forwardRef((_a, ref) => {
    var { style, placement, arrowProps, utilities = "", children } = _a, divProps = __rest(_a, ["style", "placement", "arrowProps", "utilities", "children"]);
    return (React__default.createElement(motion.div, Object.assign({ ref: ref, style: style, initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, "data-placement": placement, role: "tooltip", className: `tooltip bs-tooltip-${placement} ${utilities}` }, divProps),
...
export { Accordion, Alert, AlertHeading, AlertLink, Badge, Breadcrumb, BreadcrumbItem, Button, ButtonGroup, ButtonToolbar, Card, CardBody, CardFooter, CardGroup, CardHeader, CardImage, CardLink, CardSubtitle, CardText, CardTitle, Carousel, CarouselCaption, CarouselItem, Close, Collapse, Dropdown, DropdownDivider, DropdownHeader, DropdownItem, DropdownItemText, DropdownMenu, DropdownToggle, ListGroup, ListGroupItem, Manager, Modal, ModalBackdrop, ModalBody, ModalContent, ModalDialog, ModalFooter, ModalHeader, ModalTitle, Nav, NavLink, NavLinkToggle, Navbar, NavbarBrand, NavbarNav, NavbarText, NavbarToggler, Pagination, PaginationItem, Popover, PopoverElement, PopoverPopper, Progress, ProgressBar, Reference, SR, SimpleNavBar, Spinner, TabContent, TabPane, Toast, ToastBody, ToastHeader, Toaster, Tooltip, TooltipElement, Manager as TooltipManager, TooltipPopper, Reference as TooltipReference };
