...
const SR = React.forwardRef(({ children }, ref) => (React__default.createElement("span", { className: `sr-only`, ref: ref }, children)));
...
const Collapse = React.forwardRef(({ visible, utilities = "", children }, ref) => {
...
const Modal = React.forwardRef(({ utilities = "", visible, children, transition = "tween", onDismiss, scrollable = false, alignment = "top", }, ref) => {
    React.useEffect(() => {
        if (visible) {
...
const Toaster = React.forwardRef(({ utilities = "", children, duration = 5 }, ref) => {
...
const Toast = React.forwardRef(({ utilities = "", dismissable = true, title, time, onDismiss, children, body, icon, duration = 5, key, }, ref) => {
    React.useEffect(() => {
